...
def sort_step():
    ...
    sort_window.geometry('500x1000+150+0')
...
def sort_time(ko, a):
    try:
        ...
        if ko<1:
            ...
            for i in range(ko):
                arr_random.append(randint(a[0],a[1]))
...
''' Функция записи результатов на экран
    ...
    n1_outtt -
'''    
def sort_com(n1_ent, n1_outtt, ab):
    try:
        kol = int(n1_ent.get())
        if kol<1:
            raise ValueError
            ...
            sort_arr_time = sort_time(kol, ab)
...
def graf():
    ...
    graf_x = np.linspace(500,5000,10)
    graf_y = []
    for i in range(10):
        arr_rant = []
...
filemenu1.add_command(label = 'Grafic',
                      command = lambda: graf())
...
lab1 = Label(roots, text = 'Количество',
                 font = 'consolas 10',
                  bg = '#e0b0ff', fg = 'black')
lab1.place(x = 45,y = 30)

lab1 = Label(roots, text = 'Диапазон значений',
                 font = 'consolas 10',
                  bg = '#e0b0ff', fg = 'black')
lab1.place(x = 145,y = 30)

n1_label = Label(roots, text = 'N1',
                 font = 'consolas 10',
                  bg = '#e0b0ff', fg = 'black')
n1_label.place(x = 10,y = 60)

n1_entry = Entry(roots, width = 18)
n1_entry.place(x = 30, y =60)
n1_entry.focus_set()

n1_aa = Entry(roots, width = 18)
n1_aa.place(x = 150, y =60)

n2_label = Label(roots, text = 'N2',
                 font = 'consolas 10',
                  bg = '#e0b0ff', fg = 'black')
n2_label.place(x = 10,y = 90)

n2_entry = Entry(roots, width = 18)
n2_entry.place(x = 30, y = 90)

n2_aa = Entry(roots, width = 18)
n2_aa.place(x = 150, y =90)

n3_label = Label(roots, text = 'N3',
                 font = 'consolas 10',
                  bg = '#e0b0ff', fg = 'black')
n3_label.place(x = 10,y = 120)

n3_entry = Entry(roots, width = 18)
n3_entry.place(x = 30, y = 120)

n3_aa = Entry(roots, width = 18)
n3_aa.place(x = 150, y =120)

n1 = Label(roots, text = 'N1',
                 font = 'consolas 10',
                  bg = '#e0b0ff', fg = 'black')
n1.place(x = 200,y = 150)
n2 = Label(roots, text = 'N2',
                 font = 'consolas 10',
                  bg = '#e0b0ff', fg = 'black')
n2.place(x = 350,y = 150)
n3 = Label(roots, text = 'N3',
                 font = 'consolas 10',
                  bg = '#e0b0ff', fg = 'black')
n3.place(x = 500,y = 150)

upr_label = Label(roots, text = 'Упорядоченный по\n возрастанию массив',
                 font = 'consolas 10',
                  bg = '#e0b0ff', fg = 'black')
upr_label.place(x = 0,y = 169)

upr_label = Label(roots, text = 'Массив заполненный\n случайными числами',
                 font = 'consolas 10',
                  bg = '#e0b0ff', fg = 'black')
upr_label.place(x = 0,y = 220)

upr_label = Label(roots, text = 'Упорядоченный по\n убыванию массив',
                 font = 'consolas 10',
                  bg = '#e0b0ff', fg = 'black')
upr_label.place(x = 5,y = 267)

n1_sort_upr = Entry(roots, width = 18)
n1_sort_upr.place(x = 150, y = 175)
n1_sort_sl = Entry(roots, width = 18)
n1_sort_sl.place(x = 150, y = 225)
n1_sort_obr = Entry(roots, width = 18)
n1_sort_obr.place(x = 150, y = 275)

n2_sort_upr = Entry(roots, width = 18)
n2_sort_upr.place(x = 300, y = 175)
n2_sort_sl = Entry(roots, width = 18)
n2_sort_sl.place(x = 300, y = 225)
n2_sort_obr = Entry(roots, width = 18)
n2_sort_obr.place(x = 300, y = 275)

n3_sort_upr = Entry(roots, width = 18)
n3_sort_upr.place(x = 450, y = 175)
n3_sort_sl = Entry(roots, width = 18)
n3_sort_sl.place(x = 450, y = 225)
n3_sort_obr = Entry(roots, width = 18)
n3_sort_obr.place(x = 450, y = 275)
...
sort_all_button = Button(roots, text = 'Sort',
                         ...
                         font = 'consolas 10',
                         bg = 'white', fg = 'black',
                         command = lambda:(sort_com(n1_entry, n1_out, list_get1(n1_aa)),
                                           sort_com(n2_entry, n2_out, list_get1(n2_aa)),
                                           sort_com(n3_entry, n3_out, list_get1(n3_aa))))
sort_all_button.place(x = 350, y = 70)

exit_but =  Button(roots, text='Exit',width = 15,height = 2,
                   font='consolas 10',
                   bg = 'white',fg = 'black',
                   command = lambda: roots.destroy())
exit_but.place(x=250, y=325)
